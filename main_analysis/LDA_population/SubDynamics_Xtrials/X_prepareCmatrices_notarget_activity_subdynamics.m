function [acmatgo,acmatnogo,acrepgo,acrepnogo,ac_go,ac_nogo] = ...
    X_prepareCmatrices_notarget_activity_subdynamics(animalmodel,includedanimals,...
...
for animalnum = includedanimals
   ...
   notargetcell =  subselectdynamiccells(notargetcell,ratio); 
    ...
    for repi = 1: animalmodel{animalnum}.lmodel.nrep
        for i = 1:8
            for j = 1:8
                ...
                % remove nans: (set to 0 similar to lda) (is it ok?)
