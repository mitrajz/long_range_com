...
% - included animals are set by hand (from the previous inspection of
%   performance) - animal 1 is excluded due to chance performance.
...
lmodel.filename = [lmodel.exptype,'lmodel_U_25Th_',lmodel.binsizems,'ms_X_style',num2str(lmodel.Xstyle),'_nrep',num2str(lmodel.nrep),'.mat'];
lmodel.hyperfilename = ['hyper_',lmodel.exptype,'lmodel_U_25Th',lmodel.binsizems,'ms_C1_R1_CV10.mat'];
lmodel.cellfiletoload = ['cells_U_',lmodel.exptype,'_pl20_an',lmodel.binsizems,'_lw20_exG0_onlyC0_onlyS0_plstyle1.mat'];
